...
venue: "OBIS-USA, IOOS, Hakai, CIOOS, MBON, OTN"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "April 18-20, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: [] # boxed, comma-separated list of instructors' names as strings, like ["Abby Benson", "Mathew Biddle", "Sarah Bingo", "Enrique Montes", "Tylar Murray", "Jonathan Pye", "Tim van der Stap"]
helper: [] # boxed, comma-separated list of helper's names as strings, like ["Ben Best", "Brett Johnson", "Dan Otis", "Carolina Peralta"]
