...
Should we clarify/specify under which circumstances the DNA-derived extension can/should be linked to the occurrence core/extension, and when to the event core?

Do we need clarification on OTUs / ASVs, given our target audience?
...
Category 4 (metabarcoding): Name references (e.g. iBOL) = DNA-derived names, derived from clustering (OTU) or denoising (ASV) → I believe this would be for metabarcoding data.
...
Table x. Recommended fields for Occurrence core or extension. An extended version of this table is found in GBIF manual.
...
## References
1. https://docs.gbif.org/publishing-dna-derived-data/1.0/en/
2. https://manual.obis.org/examples.html
3. http://rs.gbif.org/extension/gbif/1.0/dna_derived_data_2021-07-05.xml

## Example Datasets
1. https://obis.org/dataset/62b97724-da17-4ca7-9b26-b2a22aeaab51
2. https://obis.org/dataset/b7041269-d327-49fc-9c2d-729e971158b9
3. Steve’s Rockefeller University dataset
